/* eslint-disable */
/**
 * waitReady() provides a tool for detecting page/DOM nodes
 * it was imported from https://gist.github.com/elgalu/2939aad2b2e31418c1bb
 *
 * waitExists() is a copy of waitReady() with the exception that it
 * will succeed as soon as the node exists, even if it is not visible.
 */
/**
...
ElementFinder.prototype.waitExists = function() {
    var self = this;
